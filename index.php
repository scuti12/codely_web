      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up" style="margin: 10px;">
            ...
            <a href="codely_web/lessons/html_css.php"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up" style="margin: 10px;">
            ...
            <a href="codely_web/lessons/js.php"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up" style="margin: 10px;">
            ...
            <a href="codely_web/lessons/bootstrap.php"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up" style="margin: 10px;">
            ...
            <a href="codely_web/lessons/cpp.php"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up" style="margin: 10px;">
            ...
            <a href="codely_web/lessons/java.php"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up" style="margin: 10px;">
            ...
            <a href="codely_web/lessons/linux.php"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up" style="margin: 10px;">
            ...
            <a href="codely_web/lessons/git.php"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up" style="margin: 10px;">
            ...
            <a href="codely_web//lessons/php.php"></a>
          </figure>
        </div>
        <div class="col-md-4 col-sm-6 padleft-right">
          <figure class="imghvr-fold-up" style="margin: 10px;">
            ...
            <a href="codely_web/lessons/mysql.php"></a>
          </figure>
        </div>
        </div>
      </div>
